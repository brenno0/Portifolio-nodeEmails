/*
  ...
  - You are about to alter the column `activeFlag` on the `Products` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
