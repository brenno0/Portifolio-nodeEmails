...
INSERT INTO "new_Products" ("activeFlag", "banksId", "categoryId", "created_At", "id", "name", "price", "userId") SELECT "activeFlag", "banksId", "categoryId", "created_At", "id", "name", "price", "userId" FROM "Products";
DROP TABLE "Products";
